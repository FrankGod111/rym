...
export const erpApi = {
  ...
  linkDifyDocument: (difyDocumentId: string, values: { name: string; scope_id: string; scope_name?: string; catalog_item_id?: string; archive_tree_node_id?: string; visibility?: string; confidentiality_level?: string; ai_usage_scope?: string }) => request<DocumentRecord>(`/dify/documents/${encodeURIComponent(difyDocumentId)}/link`, { method: 'POST', body: JSON.stringify(values) }),
